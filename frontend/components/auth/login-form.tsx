...
const LoginForm = ({signInWithEmail, clerkError}: LoginFormProps ) => {
    return (
                    ...
                    >
                        <FieldGroup>
                            <div className="flex flex-col items-center gap-2 text-center">
                                ...
                                {clerkError && (
                                    <h2 className="text-red-500 font-medium mt-4">
                                        {clerkError}
                                    </h2>
                                )}
                            </div>
            ...
            <div className="h-auto bg-blue-700 rounded-xl md:rounded-3xl w-80 md:w-96">
                <div className="p-6 md:p-8">
                    ...
                    <p className="text-sm font-light text-center text-white">
                        ...
                        <Link className="ml-2 text-slate-200" href="/register">
                            Register
                        </Link>
                    </p>
                </div>
